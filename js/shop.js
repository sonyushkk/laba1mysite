$(document).ready(function() {
	...
	function addRow() {
		...
		/*	document.querySelector('.cart-body').insertAdjacentHTML(
			...
			$('.product0').val("Фигурка Годжо Сатору");
			$('.amount0').val(cart[i]);
					break;
			...
			$('.product1').val("Манга Магическая битва");
			$('.amount1').val(cart[i]);
					break;
			...
			$('.product4').val("Фигурка Итадори Юдзи");
			$('.amount4').val(cart[i]);
					break;
